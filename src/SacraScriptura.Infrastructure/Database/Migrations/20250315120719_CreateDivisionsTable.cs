        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    book_id = table.Column<string>(type: "character varying(18)", unicode: false, maxLength: 18, nullable: false, collation: "C"),
                    parent_id = table.Column<string>(type: "character varying(18)", unicode: false, maxLength: 18, nullable: true, collation: "C"),
